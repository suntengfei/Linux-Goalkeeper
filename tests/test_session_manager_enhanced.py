...
class TestClientContext:
    ...
    def test_chat_messages_limit(self):
        ...
        assert context.chat_messages[-1]["content"] == "Message 24"
...
class TestSessionManager:
    ...
    @pytest.mark.asyncio
    async def test_register_nonexistent_session(self, session_manager):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_session(self, session_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_all_clients(self, session_manager):
